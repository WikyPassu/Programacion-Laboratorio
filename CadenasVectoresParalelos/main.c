...
void ordenarEmpleados(int[], float[], char[], char[][20], float[], int);
...
int main()
{
    ...
    ordenarEmpleados(legajos, sueldoBruto, sexos, nombres, sueldoNeto, T);
...
void ordenarEmpleados(int legajos[], float sueldoBruto[], char sexos[], char nombres[][20], float sueldoNeto[], int tam)
{
    int i, j;
    int auxEntero;
    float auxFlotante;
